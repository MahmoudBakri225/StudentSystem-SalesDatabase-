...
namespace P02_SalesDatabase.Migrations
{
    ...
    [Migration("20240226180807_ProductsAddColumnDescription")]
            ...
            modelBuilder.Entity("P02_SalesDatabase.Models.Sale", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SaleId = 1,
                            CustomerId = 1,
                            Date = new DateTime(2024, 2, 26, 20, 8, 7, 24, DateTimeKind.Local).AddTicks(6454),
                            ProductId = 1,
                            StoreId = 1
                        },
                        new
                        {
                            SaleId = 2,
                            CustomerId = 2,
                            Date = new DateTime(2024, 2, 26, 20, 8, 7, 24, DateTimeKind.Local).AddTicks(6514),
                            ProductId = 2,
                            StoreId = 2
                        });
                });
