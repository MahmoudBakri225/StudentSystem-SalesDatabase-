...
namespace P02_SalesDatabase.Migrations
{
    ...
    [Migration("20240226165901_InitialCreate")]
            ...
            modelBuilder.Entity("P02_SalesDatabase.Models.Sale", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SaleId = 1,
                            CustomerId = 1,
                            Date = new DateTime(2024, 2, 26, 18, 59, 0, 912, DateTimeKind.Local).AddTicks(7684),
                            ProductId = 1,
                            StoreId = 1
                        },
                        new
                        {
                            SaleId = 2,
                            CustomerId = 2,
                            Date = new DateTime(2024, 2, 26, 18, 59, 0, 912, DateTimeKind.Local).AddTicks(7741),
                            ProductId = 2,
                            StoreId = 2
                        });
                });
